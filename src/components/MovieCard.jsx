...
const MovieCard = ({ props, dir }) => {
  ...
  return (
    <div className="w-full h-[285px] rounded-lg relative">
      <div className="w-full h-[285px] bg-gradient-to-t from-neutral-800 to-transparent absolute -z-40 absolute rounded-lg"></div>
      <img
        className=" h-[285px] w-full rounded-lg absolute -z-50"
        src={img}
        alt="image slide 1"
      />
